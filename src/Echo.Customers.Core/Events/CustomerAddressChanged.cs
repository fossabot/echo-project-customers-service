namespace Echo.Customers.Core.Events
{
    ...
    public class CustomerAddressChanged : IDomainEvent
    {
        ...
        /// </summary>
        public CustomerAddress Previous { get; }

        /// <summary>Initializes a new instance of the <see cref="CustomerAddressChanged" /> class.</summary>
        /// <param name="customer">The customer.</param>
        /// <param name="previous"></param>
        public CustomerAddressChanged(Customer customer, CustomerAddress previous)
